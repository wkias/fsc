...
#define ADC_SAMPLING_PARAMETER_SLOPE 3
//ADC-电感高度-cm
#define ADC_SAMPLING_PARAMETER_HEIGHT 3
//ADC-前瞻距离-cm
#define ADC_SAMPLING_PARAMETER_FORWARD 10
...
#define SERVO_PID_PARAMETER_D 1.2
...
//舵机-电机-输出参数比例
#define PARAMENTER_SERVO_MOTOR_RATIO 2
